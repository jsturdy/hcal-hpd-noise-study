...
chain.Add("root://eoscms//eos/cms/store/caf/user/chenyi/HcalNoiseTree/V00-03-12142/537p6/FT_P_V42D/HBHEYesHFNoHONo/000003/HTMHT/NoiseTree_9.root")
...
analysisTree.Draw("RBXCharge:RBXEnergy","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("RBXEnergy:IEta","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("RBXCharge:IEta","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("Energy:IEta","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("Energy:Depth","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("HPDHits:IEta","","colz")
raw_input("Press Enter to continue...")
analysisTree.Draw("HPDHits:Depth","","colz")
raw_input("Press Enter to continue...")
